...
library(vegan)
library(coin)
setwd("~/Dropbox/My_Publications/GlobalBleachingModelRandR/EcologySubmission/SM/DataS2") #set your correct working directory
```
#### Note on this code:
...
main<-ggplot( Main_oceans, aes(x=as.factor(Spatial.Scale), y=R,fill=Simulation)) +
  ...
  labs(x="Global and Oceans",y="Resistance")+
  geom_text(aes( label=statlab,y=R+R_std+0.1),position = position_dodge(1),vjust =0)
...
```
Code for settingup for toelrancea function
```{r}
